...
// Returns the private 'App\Repository\UserPartenaireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserPartenaireRepository.php';

return $this->privates['App\\Repository\\UserPartenaireRepository'] = new \App\Repository\UserPartenaireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
