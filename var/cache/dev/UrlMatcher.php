...
return [
    ...
    [ // $staticRoutes
        ...
        '/api/user' => [[['_route' => 'user', '_controller' => 'App\\Controller\\UserController::index'], null, null, null, false, false, null]],
        '/apiapi/partenaires' => [[['_route' => 'ajouPartenaire', '_controller' => 'App\\Controller\\UserController::ajoutPartenaire'], null, ['POST' => 0], null, false, false, null]],
        '/api/userPartenaires' => [[['_route' => 'addUserPartenaire', '_controller' => 'App\\Controller\\UserController::addUserPartenaire'], null, ['POST' => 0], null, false, false, null]],
