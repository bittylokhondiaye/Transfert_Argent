...
// Returns the private 'App\Repository\SuperAdminRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SuperAdminRepository.php';

return $this->privates['App\\Repository\\SuperAdminRepository'] = new \App\Repository\SuperAdminRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
